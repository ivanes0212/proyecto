...
use Uni\Bundle\ProyectoBundle\Entity\juegos;
use Uni\Bundle\ProyectoBundle\Form\juegosType;
...
class juegosController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('uniProyectoBundle:juegos')->findAll();

        return $this->render('uniProyectoBundle:juegos:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('uniProyectoBundle:juegos:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('uniProyectoBundle:juegos')->find($id);
        ...
        return $this->render('uniProyectoBundle:juegos:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('uniProyectoBundle:juegos:edit.html.twig', array(
            'entity'      => $entity,
