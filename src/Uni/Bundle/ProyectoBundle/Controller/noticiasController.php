...
use Uni\Bundle\ProyectoBundle\Entity\noticias;
use Uni\Bundle\ProyectoBundle\Form\noticiasType;
...
class noticiasController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('uniProyectoBundle:noticias')->findAll();

        return $this->render('uniProyectoBundle:noticias:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('uniProyectoBundle:noticias:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('uniProyectoBundle:noticias')->find($id);
        ...
        return $this->render('uniProyectoBundle:noticias:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('uniProyectoBundle:noticias:edit.html.twig', array(
            'entity'      => $entity,
